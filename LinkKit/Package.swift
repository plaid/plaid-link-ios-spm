...
/// "https://github.com/plaid/plaid-link-ios/archive/refs/tags/5.6.0/LinkKit.xcframework.zip",
let linkKitXCFramework = Target.binaryTarget(
  name: "LinkKit",
  url: "https://github.com/plaid/plaid-link-ios/archive/refs/tags/5.6.0.zip",
...
let package = Package(
  ...
  targets: [
    ...
    .target(name: "LinkKitSub", path: "Sources"),
  ]
)
